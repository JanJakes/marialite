...
write_build_report() {
...

  {
    ...
    grep -E "^(AWS_SDK_EXTERNAL_PROJECT|BUILD_CONFIG|DISABLE_SHARED|FEATURE_SET|MYLITE_DISABLE_ARIA|PLUGIN_[A-Z0-9_]+|UPDATE_SUBMODULES|USE_ARIA_FOR_TMP_TABLES|WITH_[A-Z0-9_]+|WITHOUT_DYNAMIC_PLUGINS):" \
