...
> Superseded note: this slice documented the earlier unsupported copy-ALTER
> boundary. `docs/specs/descending-hash-index-storage/specs.md` later added
> support for `USING HASH` and descending BTREE key parts, and
> `docs/specs/fulltext-index-storage/specs.md` later added FULLTEXT copy ALTER
> support. `docs/specs/geometry-spatial-storage/specs.md` later added GEOMETRY
> and SPATIAL copy ALTER support.
